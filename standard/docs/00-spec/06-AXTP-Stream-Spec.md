...
MVP 推荐：HID/BLE OTA 使用 Compact Frame CRC8 + stop_and_wait ACK + `verifyType=md5`；WebSocket/TCP OTA 使用 Standard Frame CRC16 + sliding_window ACK + `verifyType=sha256`。
