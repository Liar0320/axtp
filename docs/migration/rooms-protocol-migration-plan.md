...
> Source evidence: `docs/legacy-protocols/Rooms协议文档.md`
...
`docs/legacy-classification/by-source/rooms_ws_json.md` 已经把 Rooms 旧 method/event 粗分类到候选 AXTP domain.feature，例如：
