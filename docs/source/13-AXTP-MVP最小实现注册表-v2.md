...
本节与 `registry/capability/capability_registry.yaml` 及 `registry/domains/<domain>/domain.yaml` 保持一致，采用”单项 bool / 单项配置值”能力风格。
...
| `AlphaUpgradeInfo` | `0xA0001` | `firmware.getInfo` | `0x0B01` 或保留旧值 | 可选/P1 |
| `AlphaUpgradeStart` | TBD | `firmware.begin` | `0x0B02` | 必须 |
| `AlphaUpgradeEnd` | TBD | `firmware.end` | `0x0B03` | 必须 |
| `AlphaUpgradeVerify` | TBD | `firmware.verify` | `0x0B04` | 必须 |
