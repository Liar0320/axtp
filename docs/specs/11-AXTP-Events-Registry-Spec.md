...
| `0x0402` | `firmware.otaProgressReported` | draft | OTA 进度上报，待 `firmware.ota` 草案采纳 |
| `0x0403` | `firmware.otaStateChanged` | draft | OTA 状态变化，待 `firmware.ota` 草案采纳 |
| `0x0404` | `firmware.otaResultReported` | draft | OTA 结果上报，待 `firmware.ota` 草案采纳 |
...
| OTA 进度/状态/结果上报 | 待 `firmware.ota` 草案采纳后映射 |
